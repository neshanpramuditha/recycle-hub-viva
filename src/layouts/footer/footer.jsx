            ...
            <div className="col-lg-3 col-md-6 mb-4">
              <div className="footer-brand">
                ...
                <p className="brand-description">
                  Your trusted marketplace for buying and selling second-hand
                  items. Join our community in promoting sustainability and
                  circular economy through conscious consumption.
                </p>
