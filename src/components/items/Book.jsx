        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="form-section">
              ...
              <div className="mb-3">
                <label className="form-label">Book Type/Category:</label>
                <input
                  type="text"
                  className="form-control"
                  placeholder="Textbooks, novels, magazines, newspapers, etc."
                  value={itemName}
              ...
              <div className="calculator-section mb-4">
                ...
                <div className="number-grid">
                  ...
                  <button className="btn btn-outline-success num-btn" onClick={() => setCount(prev => prev + 25)}>
                    +25
                  </button>
                </div>
              </div>
              ...
              <div className="mb-3">
                ...
                <textarea
                  className="form-control"
                  rows="3"
                  placeholder="Condition of books, subjects, languages, approximate weight..."
                  value={message}
          ...
          <div className="col-lg-6">
            <div className="preview-section">
              <img
                src="/src/assets/images/book-recycling.jpg"
                alt="Book recycling"
                className="hero-image mb-4"
                onError={(e) => { e.target.src = '/src/assets/images/6.jpg'; }}
              />
              ...
              <div className="card info-card">
                <div className="card-body">
                  <h5 className="card-title">
                    <FaBook className="me-2 text-primary" />
                    Book Submission Summary
                  </h5>
                  {isSubmitted ? (
                    <ul className="list-unstyled">
                      <li><strong>Book Type:</strong> {itemName}</li>
                      <li><strong>Count:</strong> {count} books</li>
                    ...
                    <div>
                      <p className="text-muted">Fill out the form to see your book submission summary</p>
                      <small className="text-info">
                        📚 Consider donating books in good condition to libraries or schools before recycling!
                      </small>
                    </div>
                  )}
