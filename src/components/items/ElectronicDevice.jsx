...
import { FaLightbulb, FaMobile, FaLaptop, FaTv } from 'react-icons/fa';
        ...
        <div className="row">
            ...
            <div className="form-section">
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  placeholder="Phone, laptop, TV, tablet, etc."
                  value={itemName}
              ...
              <div className="mb-3">
                ...
                <textarea
                  className="form-control"
                  rows="3"
                  placeholder="Working condition, brand, model, any accessories..."
                  value={message}
          ...
          <div className="col-lg-6">
            <div className="preview-section">
              <img
                src="/src/assets/images/electronics.jpg"
                alt="Electronic device recycling"
                className="hero-image mb-4"
                onError={(e) => { e.target.src = '/src/assets/images/4.jpg'; }}
              />
                ...
                <div className="card-body">
                  ...
                  {isSubmitted ? (
                    <ul className="list-unstyled">
                      <li><strong>Device Type:</strong> {itemName}</li>
                    ...
                    <div>
                      <p className="text-muted">Fill out the form to see your device submission summary</p>
                      <small className="text-warning">
                        ⚠️ Important: Please ensure all personal data is removed from devices before recycling!
                      </small>
                    </div>
                  )}
